...
import witlab.utils.paths as paths
import witlab.utils.pypetUtils as pu
import numpy as np
import pytest
import xarray as xr
...
from witlab.models.multimodel.builder.fitzhugh_nagumo import FitzHughNagumoNetwork
