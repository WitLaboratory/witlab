...
import sympy as sp
from witlab.models.multimodel.builder.base.constants import EXC, INH
from witlab.models.multimodel.builder.base.network import (
    Network,
    Node,
    SingleCouplingExcitatoryInhibitoryNode,
    _sanitize_matrix,
)
from witlab.models.multimodel.builder.base.neural_mass import NeuralMass
from witlab.utils.stimulus import OrnsteinUhlenbeckProcess, ZeroInput
